...
import net.larry1123.util.config.fieldhanders.booleans.BooleanFieldHandler;
import net.larry1123.util.config.fieldhanders.booleans.BooleanWrapFieldHandler;
import net.larry1123.util.config.fieldhanders.bytes.*;
import net.larry1123.util.config.fieldhanders.character.CharacterFieldHandler;
import net.larry1123.util.config.fieldhanders.character.CharacterWrapFieldHandler;
import net.larry1123.util.config.fieldhanders.doubles.*;
import net.larry1123.util.config.fieldhanders.floats.*;
import net.larry1123.util.config.fieldhanders.intergers.*;
import net.larry1123.util.config.fieldhanders.longs.*;
import net.larry1123.util.config.fieldhanders.shorts.*;
import net.larry1123.util.config.fieldhanders.strings.StringArrayFieldHandler;
import net.larry1123.util.config.fieldhanders.strings.StringArrayListFieldHandler;
import net.larry1123.util.config.fieldhanders.strings.StringFieldHandler;
...
public class FactoryManager {
    ...
    public void addDefaultHandlers(FieldHandlerFactory factory) {
        ...
        factory.addHandler(getParameterizedTypeImplFactory().MakeTypeImpl(ArrayList.class, Byte.class), ByteArrayListFieldHandler.class);
        // Character
        ...
        factory.addHandler(getParameterizedTypeImplFactory().MakeTypeImpl(ArrayList.class, Double.class), DoubleArrayListFieldHandler.class);
        // Float
        ...
        factory.addHandler(getParameterizedTypeImplFactory().MakeTypeImpl(ArrayList.class, Float.class), FloatArrayListFieldHandler.class);
        // Integer
        ...
        factory.addHandler(getParameterizedTypeImplFactory().MakeTypeImpl(ArrayList.class, Integer.class), IntegerArrayListFieldHandler.class);
        // Long
        ...
        factory.addHandler(getParameterizedTypeImplFactory().MakeTypeImpl(ArrayList.class, Long.class), LongArrayListFieldHandler.class);
        // Short
        ...
        factory.addHandler(getParameterizedTypeImplFactory().MakeTypeImpl(ArrayList.class, Short.class), ShortArrayListFieldHandler.class);
        // String
        factory.addHandler(String.class, StringFieldHandler.class);
        factory.addHandler(String[].class, StringArrayFieldHandler.class);
        factory.addHandler(getParameterizedTypeImplFactory().MakeTypeImpl(ArrayList.class, String.class), StringArrayListFieldHandler.class);
    }

    public ParameterizedTypeImplFactory getParameterizedTypeImplFactory() {
        if (parameterizedTypeImplFactory == null) {
